...
int main() {
    ...
    // /Users/user/CLionProjects/ACS_Sizov_Vlad_HW1/test1.txt
    // /Users/user/CLionProjects/ACS_Sizov_Vlad_HW1/Test/output1.txt
    ...
    std::ifstream in(inputFileName); // окрываем файл для чтения
    if (in.is_open())
    {
